...
%xlabel('循环频率α [Hz]'),ylabel('频率f [Hz]');title('3-D循环谱相关');
...
%title('增强包络谱EES');xlabel('循环频率α [Hz]');ylabel('平均谱相干');
...
% uicontrol('parent',H.p1,'Style','text','string','参数设置','Units','pixels','Position',...
%              [0 200 130 25],'fontsize',15,'BackgroundColor','w','FontName','黑体');
...
% uicontrol('parent',H.p1,'Style','text','string','连续频率分辨率df（Hz）','Units','pixels','Position',...
...
% uicontrol('parent',H.p3,'Style','text','string','高级设置：','Units','pixels','Position',...
